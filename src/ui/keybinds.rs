...
pub const KEYBINDS: &[KeybindEntry] = &[
    ...
    KeybindEntry { key: "0", description: "Start of line", context: "copy" },
    KeybindEntry { key: "$", description: "End of line", context: "copy" },
    KeybindEntry { key: "w", description: "Next word", context: "copy" },
    KeybindEntry { key: "e", description: "End of word", context: "copy" },

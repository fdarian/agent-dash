...
export function DocsNav() {
  ...
  return (
    <nav className="ad-nav">
      <div className="ad-nav-inner ad-nav-inner-wide">
        <div style={{ display: 'flex', alignItems: 'center', gap: 24 }}>
          <Link href="/" className="ad-brand">
            <div className="ad-brand-mark" />
            agent-dash
          </Link>
          <div className="ad-nav-mid">
            <Link href="/">home</Link>
            <Link href="/docs" className={onDocs ? 'on' : ''}>
              docs
            </Link>
        ...
        <div className="ad-nav-right">
          <div className="ad-search" role="button" aria-label="Search docs">
            <span>⌕</span>

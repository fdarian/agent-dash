    ...
    <div className="relative mx-auto max-w-4xl">
      <div className="rounded-xl border border-fd-border dark:border-[#1e2028] bg-[#0e1013] overflow-hidden">
        ...
        <div className="flex items-center gap-2 px-4 py-2.5 border-b border-white/[0.06] bg-white/[0.015]">
          ...
          <span className="text-xs text-white/25 ml-2 font-mono">
            agent-dash
          </span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-[200px_1fr] divide-y md:divide-y-0 md:divide-x divide-white/[0.06] min-h-[280px] font-mono text-[13px] leading-[22px]">
          ...
          <div className="hidden md:block p-3 text-white/40 select-none">
            ...
            <div className="mt-5 text-center text-white/15 text-[11px]">
              &#x2500;&#x2500;&#x2500; Hidden (1) &#x2500;&#x2500;&#x2500;
            </div>
          </div>
          ...
          <div className="p-3 text-white/50 select-none">
            ...
            <div className="mt-3">
              I&apos;ll analyze the authentication module and suggest
              improvements.
            </div>
            ...
            <div className="mt-4 text-center text-brand/60 text-[11px]">
              &#x2500;&#x2500;&#x2500;&#x2500; Plan
              &#x2500;&#x2500;&#x2500;&#x2500;
            </div>
          </div>
        ...
        <div className="flex justify-between px-4 py-1.5 border-t border-white/[0.06] bg-white/[0.015] font-mono text-[11px] text-white/25 select-none">
          <span>
            <span className="text-emerald-400">&#x25cf;</span> 3 Active
            &nbsp;&nbsp;2 Groups
          </span>
...
function FeatureCard(props: FeatureCardProps) {
  return (
    <div className="rounded-xl border border-fd-border bg-fd-card p-6 transition-colors hover:bg-fd-accent">
      <h3 className="text-[15px] font-semibold tracking-tight text-fd-card-foreground">
        {props.title}
      </h3>
...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-fd-background text-fd-foreground antialiased relative">
      ...
      <main className="relative z-10">
        ...
        <section className="pt-28 pb-16 px-6">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1
              className="animate-fade-up text-5xl sm:text-6xl lg:text-[4.5rem] font-bold tracking-[-0.03em] leading-[1.05]"
            ...
            <p
              className="animate-fade-up mt-6 text-lg text-fd-muted-foreground max-w-xl mx-auto leading-relaxed"
              style={{ animationDelay: '160ms' }}
            >
              A keyboard-first terminal dashboard for managing and monitoring
              Claude AI sessions in tmux.
            </p>

            <div
              className="animate-fade-up flex flex-wrap gap-3 justify-center mt-10"
              style={{ animationDelay: '240ms' }}
            >
              <Link
                href="/docs"
                className="fancy-button inline-flex items-center gap-2 rounded-[10px] bg-brand px-5 py-2.5 text-sm font-medium text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.12),0_1px_3px_rgba(0,0,0,0.2),0_2px_8px_rgba(217,119,87,0.25)] hover:brightness-110 transition"
              >
                Get Started
                <ArrowRightIcon />
              </Link>
              <a
                href="https://github.com/fdarian/agent-dash"
                className="inline-flex items-center gap-2 rounded-[10px] border border-fd-border bg-fd-card px-5 py-2.5 text-sm font-medium text-fd-foreground hover:bg-fd-accent transition"
                target="_blank"
                rel="noopener noreferrer"
              >
                <GithubIcon />
        ...
        {/* ─── Terminal Demo ─── */}
        <section
          className="animate-fade-up px-6 pb-8"
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center gap-3">
                <div className="w-14 h-14 rounded-full border border-fd-border bg-fd-muted flex items-center justify-center group-hover:bg-fd-accent transition-colors">
                  <svg
                    ...
                    viewBox="0 0 20 20"
                    fill="currentColor"
                    className="ml-0.5 text-fd-muted-foreground"
                  >
        ...
        {/* ─── Features ─── */}
        <section className="px-6 py-24 border-t border-fd-border">
          <div className="mx-auto max-w-6xl">
            <div className="text-center mb-14">
              ...
              <p className="mt-4 text-fd-muted-foreground text-lg">
                Everything you need to manage Claude sessions, nothing you
                don&apos;t.
              </p>
            </div>
        ...
        <section className="px-6 py-24 border-t border-fd-border">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-fd-muted-foreground text-lg mb-12">
              Every action at your fingertips. Press <Key>?</Key> for the
              full reference.
            </p>
            <div className="inline-grid grid-cols-2 sm:grid-cols-3 gap-x-10 gap-y-5 text-left">
              {keybinds.map((bind) => (
                <div key={bind.label} className="flex items-center gap-3">
          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="rounded-xl border border-fd-border dark:border-[#1e2028] bg-[#0e1013] p-5 text-left font-mono text-[13px] leading-7 overflow-x-auto">
              <div className="text-white/35">
                <span className="text-emerald-400/70">$</span> git clone
                https://github.com/fdarian/agent-dash.git
              </div>
              <div className="text-white/35">
                <span className="text-emerald-400/70">$</span> cd agent-dash
                &amp;&amp; cargo build --release
              </div>
              <div className="text-white/35">
            ...
            <Link
              ...
              className="inline-flex items-center gap-1 mt-6 text-sm text-brand hover:brightness-125 transition"
            >
        ...
        <div className="mx-auto max-w-6xl px-6 py-12">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-6">
            <div className="text-sm text-fd-muted-foreground">
              Agent Dash &mdash; Open source, Apache-2.0 licensed.
            </div>

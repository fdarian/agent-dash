---
title: Agent Dash
description: A TUI dashboard for managing Claude AI sessions in tmux
---

Agent Dash is a terminal user interface (TUI) application for managing and monitoring [Claude](https://claude.ai) AI sessions running in tmux.
